...
<div class="flex items-center gap-3">
	...
	<div class="flex items-center gap-2">
		...
		<div class="flex items-center bg-dark-card border border-dark-border rounded px-3 py-1.5">
			...
			<input
				...
				oninput={handleInput}
				onblur={handleBlur}
				class="w-28 bg-transparent text-dark-text text-lg font-medium focus:outline-none"
				placeholder="100000"
			/>
		</div>
	</div>
